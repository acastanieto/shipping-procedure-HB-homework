...
# Add Squash Class definition here.
class Squash(Melon):
    def __init__(self):
        return super(Squash, self).__init__("Squash")

    def prep(self):
        """Prepare the Squash and paint it green"""
...
def main():
    """Assesses and packs order objects. Distinguishes between
    melons/squashes."""
